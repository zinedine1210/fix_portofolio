      ...
      <section className="px-4 pb-16 pt-6 sm:px-6 lg:px-8 lg:pt-10">
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <h1 className="mt-4 text-balance text-4xl font-semibold tracking-tight text-slate-950 dark:text-slate-50 md:text-5xl">
              {post.title}
            </h1>
            <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600 dark:text-slate-400">{post.excerpt}</p>
              ...
              >
                <Link href={`/blog/${relatedPost.slug}`} className="block">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="mt-2 text-2xl font-semibold tracking-tight text-slate-950 dark:text-slate-50">{relatedPost.title}</h3>
