...
export default function ProjectSlider() {
  ...
  return (
    <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-4 shadow-3xl sm:p-6">
      <div className="absolute inset-0 bg-gradient-to-br from-sky-50/70 via-white to-cyan-50/45" />
      ...
      <div className="relative overflow-hidden rounded-[1.5rem] border border-slate-200/80 bg-white">
            ...
            >
              <Link href={`/blog/${project.slug}`} className="group grid lg:grid-cols-[1.1fr_0.9fr]">
                ...
                <div className="flex flex-col justify-between gap-6 p-6 sm:p-8">
                  <div>
                    <h4 className="text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">{project.title}</h4>
                    <p className="mt-4 text-base leading-7 text-slate-600">{project.excerpt}</p>
                  </div>
