...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/zinedine',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/zinedine',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      url: 'https://instagram.com/zinedine',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="mb-4 text-xl font-semibold text-slate-950">{t('quickLinks')}</h3>
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="mb-4 text-xl font-semibold text-slate-950">{t('contactInfo')}</h3>
            <div className="space-y-3">
              ...
              >
                ...
                <span>zinedine@example.com</span>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                <span className="font-semibold text-slate-950">{t('availability')}</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
